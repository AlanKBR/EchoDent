...
from app.models import Anamnese, Paciente, RoleEnum, Usuario
...
def main():
    ...
    with app.app_context():
        ...
        paciente = (
            ...
            .filter_by(nome_completo="Paciente Teste")
            .one_or_none()
        )
        if not paciente:
            paciente = Paciente()
